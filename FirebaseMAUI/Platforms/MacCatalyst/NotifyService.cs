...
[assembly: Dependency(typeof(FirebaseMAUI.MacCatalyst.NotifyService))]

namespace FirebaseMAUI.MacCatalyst
{
    public class NotifyService : INotifyService//, IUNUserNotificationCenterDelegate//, IMessagingDelegate
    {
        public NotifyService()
        {
            //using (var firebaseOptions = new Firebase.Core.Options("GoogleService-Info.plist"))
            //{
